    ...
    extends Specification
{
  ...
  // disabled because Jenkins 1.x requires groovy 1.8 but spock requires groovy 2.x
  // more specifically because of an incompatible method signature change in groovy.lang.GroovyShell.parse
  @Ignore
  @Unroll
